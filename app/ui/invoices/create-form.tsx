...
export default function Form({ customers }: { customers: CustomerField[] }) {
  ...
  return (
    <form action={formAction} aria-describedby="form_error">
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <div id="customer_error" aria-live="polite" aria-atomic="true">
        ...
        {/* Invoice Status */}
        <fieldset aria-describedby="status_error">
      ...
      <div id="form_error" aria-live="polite" aria-atomic="true">
        {state.message && (
